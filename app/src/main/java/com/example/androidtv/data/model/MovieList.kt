...
object MovieList {
    ...
    val list: List<MovieDbModel> by lazy {
        setupMovies()
    }
    private var count: Int = 0

    private fun setupMovies(): List<MovieDbModel> {
        val title = arrayOf(
    ...
    private fun buildMovieInfo(title: String, description: String, studio: String, videoUrl: String, cardImageUrl: String, backgroundImageUrl: String): MovieDbModel {
        val movie = MovieDbModel(count++, title, description, backgroundImageUrl, cardImageUrl, videoUrl, studio)
        return movie
    }
}