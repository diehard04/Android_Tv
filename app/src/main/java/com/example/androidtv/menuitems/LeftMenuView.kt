...
class LeftMenuView : LinearLayout {
    var cllSearchView: LinearLayout? = null
    var cllHomeView: LinearLayout? = null
    var cllSettingsView: LinearLayout? = null
    var civHome: ImageView? = null
    var civSearch: ImageView? = null
    var civSettings: ImageView? = null
    var txtSearchMenuLabel:TextView ?= null
    var txtHomeMenuLabel:TextView ?= null
    var txtSettingsMenuLabel:TextView ?= null
    ...
    private fun setupMenuUI(context: Context) {
        ...
        val view = inflater.inflate(R.layout.menu_layout, this, true)
        cllSearchView = view.findViewById(R.id.cllSearchView)
        cllHomeView = view.findViewById(R.id.cllHomeView)
        cllSettingsView = view.findViewById(R.id.cllSettingsView)
        civSearch = view.findViewById(R.id.civSearch)
        civHome = view.findViewById(R.id.civHome)
        civSettings = view.findViewById(R.id.civSettings)
        txtSearchMenuLabel = view.findViewById(R.id.txtSearchMenuLabel)
        txtHomeMenuLabel = view.findViewById(R.id.txtHomeMenuLabel)
        txtSettingsMenuLabel = view.findViewById(R.id.txtSettingsMenuLabel)
    ...
    private fun highlightCurrentSelectedMenu() {
        when (currentSelected) {
            ...
            SEARCH_MENU -> {
                ...
                civSearch?.imageTintList = ColorStateList.valueOf(
                    ContextCompat.getColor(
                        this.context,
                        R.color.fluorescent_orange
                    )
        ...
        for (i in 0 until count) {
            ...
            childView.apply {
                ...
                if (!status) {
                    ...
                    background = ContextCompat.getDrawable(this.context, R.drawable.drawable_menu_hover)
                    changeMenuColor()
                }
            }
        }
