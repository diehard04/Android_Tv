 ...
 */
class AlignmentFragment : RowsSupportFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //setAlignment(1000) // top spacing
        //verticalGridView.windowAlignmentOffset
        //verticalGridView.windowAlignment = 500
        //verticalGridView.windowAlignmentOffset = 100
    }

    private fun internetConnection() {
        context?.let { Progress.showProgressBar(it) }
        val tvLauncherApiInterface: TVLauncherApiInterface? = TVLauncherApiClient.getRetrofit()?.create(
            TVLauncherApiInterface::class.java)
...
//        searchAffordanceColor = ContextCompat.getColor(activity!!, R.color.search_opaque)
    ...
    private fun loadRows() {
        ...
        val cardPresenter = AlignCardPresenter()
...
//        val mGridPresenter = AlignCardPresenter.FocusedItemAtStartListRowPresenter(2)
...
//        }
    ...
    private inner class ItemViewClickedListener : OnItemViewClickedListener {
        override fun onItemClicked(
            ...
            if (item is Movie) {
                ...
                val intent = Intent(activity!!, AlignmentActivity::class.java)
    ...
    companion object {
        private val TAG = "AlignmentFragment"
